...
- Security by default (OWASP mindset)  
- Scalable and reliable API design  

## ⚙️ Backend Stack
- **Languages**: JavaScript, TypeScript, Python, Go, SQL  
- **Frameworks**: Node.js, FastAPI, Express  
...
- Static analysis & code quality (SonarQube, ESLint)

> Backend is the backbone — it must be **secure, scalable, and clean**.
